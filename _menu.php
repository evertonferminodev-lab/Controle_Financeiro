<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-th-large fa-3x"></i> Categoria<span class="fa arrow"></span></a>
               ...
               <li>
                <a href="#"><i class="fa fa-home fa-3x"></i> Empresa<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
   ...
   <li>
                <a href="#"><i class="fa fa-usd fa-3x"></i> Conta<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
               ...
               <li>
                <a href="#"><i class="fa fa-search fa-3x"></i> Movimento<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a  href="%"><i class="fa fa-arrow-down fa-3x"></i> Sair</a>
            </li>
